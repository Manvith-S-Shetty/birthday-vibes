...
export default function Error({
  ...
  useEffect(() => {
    console.error("Wishlight Application Error:", error);
  }, [error]);
  ...
  return (
    <div className="min-h-screen bg-[var(--token-ink,#0A0A0B)] text-[var(--token-ivory,#FAF9F5)] flex flex-col items-center justify-center p-6 text-center">
      <div className="max-w-md space-y-6 animate-fade-in">
        <div className="w-16 h-16 rounded-full border border-red-500/30 bg-stone-900/80 text-red-400 flex items-center justify-center mx-auto shadow-xl">
        ...
        <div className="space-y-3">
          <p className="text-xs uppercase tracking-widest text-red-400 font-semibold font-sans">
